<?php
    ...
    function edit_data(){
      ...
      // 头像文件获取
        ...
        // 查询对象（更新数据）
        $query = mysqli_query($conn,"update student_information set name = '".$name."',xuehao = '".$xueHao."',gender = '".$gender."',phone = '".$phone."',xibie = '".$xiBie."',touxiang = '".$touName."',accountNumber = '".$accountNumber."' where id = '".$users."';");
        // 判断查询
        if(!$query){
          exit("<h1>查询失败！</h1>");
        }
  ...
  <main class="container" style="margin-top:4%;">
    ...
    ?>
      ...
      <div class="form-group">
        ...
        <input type="tel" class="form-control" id="phone" name="phone" pattern="^\d{11}$" value="<?php echo $user["phone"]?>">
      </div>
      <div class="form-group">
